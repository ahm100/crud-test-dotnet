    ...
    public class JobSeekerProfile : Profile
    {
        public JobSeekerProfile()
        {
            CreateMap<CreateJobSeekerCommand, JobSeeker>()
                .ForMember(dest => dest.Skills, opt => opt.MapFrom(src => src.Skills.Select(skill => new JobSeekerSkill { SkillName = skill }).ToList()))
            ...
            CreateMap<JobSeeker, JobSeekerDto>()
                .ForMember(dest => dest.Skills, opt => opt.MapFrom(src => src.Skills.Select(skill => skill.SkillName)))
