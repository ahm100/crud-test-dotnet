...
{
    /// <inheritdoc />
    public partial class jobsItems : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobAdvertisers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobAdvertiserId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPostings_JobAdvertisers_JobAdvertiserId",
                        column: x => x.JobAdvertiserId,
                        principalTable: "JobAdvertisers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobAdvertisers_ContactEmail",
                table: "JobAdvertisers",
                column: "ContactEmail",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_JobAdvertiserId",
                table: "JobPostings",
                column: "JobAdvertiserId");
